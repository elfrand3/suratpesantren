            ...
            <div id="content-profile" class="w-full max-w-lg bg-white rounded-xl shadow p-8 mb-8">
                ...
                <form class="space-y-5">
                    <div>
                        ...
                        <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" value="sekolah Surat">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Email</label>
                        <input type="email" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" value="sekolah@email.com">
                    </div>
                    <div>
